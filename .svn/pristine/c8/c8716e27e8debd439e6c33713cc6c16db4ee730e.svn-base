				...
				<dd>
					<ul>
						<li><a _href="/cr-admin/carUseStock/toCarUseStock.do"
							id="carUseStockListId" href="javascript:;">按车辆</a></li>
						<li><a _href="/cr-admin/statistic/toSalesMoneyList.do"
							id="salesMoneyListId" href="javascript:;">按时间</a></li>
					</ul>
				</dd>
				...
				<dd>
					<ul>
						<li><a _href="/cr-admin/stock/toComingStock.do"
							id="comingStockListId" href="javascript:;">按进货</a></li>
						<li><a _href="/cr-admin/stock/toStockStatisticList.do"
							id="stockStatisticListId" href="javascript:;">按销量</a></li>
					</ul>
				</dd>
			</dl>
